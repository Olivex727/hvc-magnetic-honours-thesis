...
\begin{figure}
    \includegraphics[width=12cm]{"Schematic Diagram.png"}
    \centering
...
While previous surveys have lacked the capacity to observe magnetic fields surrounding HVCs, the Smith Cloud is an exception to this rule due to it's size and proximity to the ISM.
