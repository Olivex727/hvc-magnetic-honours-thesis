...
%    \centering
%    \caption{Cartesian plots of peripheral data maps (left): the high-velocity HI sky from the \cite{ID6} modification of the HI4PI survey (top); the H-alpha sky from \cite{ID43} (middle); and the Hutschenreuter map from \cite{ID44, ID45} (bottom). Uncertainty maps for H-alpha and the Hutschenreuter map are displayed respectively (right). The HI uncertainty is not displayed due to it simply being a scalar multiple of the HI map.}
%    \label{fig:maps}
%\end{figure}
