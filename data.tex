...
The distortions introduced by cartesian projections need to be accounted for. HVCs located at Galactic Latitudes $|b|>80^{\circ}$ were also eliminated from the sample set. This removes one HVC to give a sample size of 14.

Lastly, it was clear that HVC G282.3-38.3+117 had not detectable HI emission according to the provided HI data. It was removed on the basis that it could not be analysed properly. This reduces the final sample to 13 HVCs.
